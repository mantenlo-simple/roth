...
<r:form action="/GroupAdmin/saveDomains" method="AJAX" onAjax="Roth.ajax.htmlCallback(request, 'userdomains')" autoComplete="off" onSubmit="Roth.getDialog('wait').wait('Please wait while your changes are saved...');">
