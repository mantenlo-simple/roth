...
<r:form action="/User/saveGroups" method="AJAX" onAjax="Roth.ajax.htmlCallback(request, 'usergroups')" autoComplete="off" onSubmit="Roth.getDialog('wait').wait('Please wait while your changes are saved...');">
    <r:dataGrid dataSource="requestScope.userGroups" height="25em" containerId="usergroups">
        ...
        <r:column caption="" dataSource="userid" width="43px">
            ...
            <r:hidden dataSource="requestScope.userGroups[${rowIndex}].domainId"/>
        ...
        <r:column caption="Group Name" dataSource="groupName" width="14em">
