...
<r:form action="/AuthenticationServlet/changeForgottenPassword" method="AJAX" onAjaxResponse="pwdAjaxResponse(request)" onAjaxError="pwdAjaxError(request, true)">
    <r:textBox id="userid" dataSource="userid" label="Username"/>
    <r:break/>
    <r:textBox id="validationCode" dataSource="validationCode" label="Validation Code"/>
    <r:break/>
