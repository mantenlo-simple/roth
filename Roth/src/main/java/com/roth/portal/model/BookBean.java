...
public class BookBean extends DataGridTreeNode implements Serializable, StateBean {
    ...
    @Override
	public Long getNodeId() { return bookId; }
	@Override
	public Long getParentNodeId() { return parentBookId; }
	@Override
