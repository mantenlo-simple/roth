...
public class RothLockOutRealm extends CombinedRealm {
	private static final Log log = LogFactory.getLog(RothLockOutRealm.class);
    ...
    public Principal authenticate(String username, String clientDigest,
            ...
            String realmName, String digestA2, String algorithm) {
