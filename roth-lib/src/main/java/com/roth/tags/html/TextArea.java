...
public class TextArea extends InputTag {
	...
	public void setWrap(String wrap) { setValue("wrap", wrap); }
	...
	public int doEndTag() throws JspException {
		...
		println(getTextArea(getId(), (String)getValue("_datasource"), value, (String)getValue("_label"), null, (String)getValue("_width"), (String)getValue("_height"), this.getHTMLAttributes()));
