...
public class CodeMirror extends InputTag {
	...
	public int doEndTag() throws JspException {
		...
		println(getCodeMirror(getId(), (String)getValue("_datasource"), value, (String)getValue("_label"), null, (String)getValue("_width"), (String)getValue("_height"), this.getHTMLAttributes()));
