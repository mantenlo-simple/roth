...
public class ChannelMessageListener implements ChannelListener {
	...
	public boolean accept(Serializable arg0, Member arg1) {
		return arg0 instanceof ChannelMessage;
	}

	@Override
	public void messageReceived(Serializable arg0, Member arg1) {
		if (arg0 instanceof ChannelQuery) {
			ChannelMessageUtil.processQuery((ChannelQuery)arg0);
		}
		else
			((ChannelMessage)arg0).receiveMessage();
	}
}
