...
<div style="width: 100%; height: calc(100% - 40px); scroll-snap-type: y mandatory; overflow-y: scroll; overflow-x: hidden;">
   	<div style="width: 100%; height: 100%; scroll-snap-align: start;">
   		<div id="schemaCont" class="roth-input" style="width: 100%; height: 100%;">
	   		<div id="tblList" class="roth-output" style="height: 100%; overflow: auto; padding: 0.8em; box-sizing: border-box; background: rgba(248,248,248,0.5);">
		        <c:forEach var="schema" items="${requestScope.schemas}">
			        <div class="unselectable" style="clear: both; cursor: pointer;" 
			            ...
			            <div style="float: left;">
				            <r:icon iconName="caret-right" style="font-size: 1.5rem; margin-right: 8px;"
				                       onClick="var c = _$('${schema}_tables'); 
	                                               ...
	                                               if ((c.style.display == 'block') && (c.innerHTML == ''))
	                                                      Roth.ajax.htmlAction(c.id, '/RothDeveloper/Developer/getDatasourceInfo', 'infoType=L&jndiname=' + _$v('jndiname') + '&schema=${schema}');"/>
			                <span style="vertical-align: 4px;">${schema}</span>
		                </div>
		                <div style="float: right;">
			                <r:icon iconName="sync-alt" title="Refresh Table List" style="color: rgba(0,0,0,0.75); font-size: 1.5rem;" 
			                         onClick="var c = _$('${schema}_tables'); 
	...
	<div id="metaCont" style="width: 100%; height: 100%; scroll-snap-align: start;">
		<r:splitPanes height="100%" width="100%" variablePane="1" orientation="vertical">
  			<r:pane fixed="true" size="70px">
	    		...
	    		<r:tabset id="objtabs" style="margin: 0.2em 0 0.2em 0.4em;"
			        ...
			        <r:option caption="Foreign K" value="" iconName="shield-alt" pageId="foreignkeys"/>
			        <r:option caption="Triggers" value="" iconName="code" pageId="triggers"/>
			    </r:tabset>
			    <r:break height="1em"/>
  			</r:pane>
  			<r:pane size="calc(100% - 70px)">
    		<div id="columns" style="width: 100%; height: 100%; box-sizing: border-box;"></div>
		    <div id="indexes" style="width: 100%; height: 100%; box-sizing: border-box; display: none;"></div>
		    <div id="data" style="width: 100%; height: 100%; box-sizing: border-box; display: none;"></div>
		    <div id="foreignkeys" style="width: 100%; height: 100%; box-sizing: border-box; display: none;"></div>
		    <div id="triggers" style="width: 100%; height: 100%; box-sizing: border-box; display: none;"></div>
  			</r:pane> 
  		</r:splitPanes>
	</div>
</div>
